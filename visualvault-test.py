...
class VV:
    ...
    def upload_document(self, dest_folder_path, uploaded_file_name, source_file_path, file_metadata = {}):
        folder_id = ""
        doc_id = ""
        ...
        file_upload_response = self.file_service.file_upload(doc_id, uploaded_file_name, "2", "", "0", "{'UVID': '10855240'}", uploaded_file_name, source_file_path)
